                ...
                <td style="width: 60%">
                    <div class="card card-default">
                        <div class="card-header text-center">
                          <b>DEPÓSITO SANTA MARÍA</b>
                        </div>
                        <div class="card-body">
                          <table style="width: 100%">
                              <tbody>
                                  <tr>
                                      <th>DEPÓSITO SANTA MARÍA</th>
                                  </tr>
                                  <tr>
                                      <th>Frente a la salida a Cuilapa, Chiquimulilla, Santa Rosa</th>
                                  </tr>
                                  <tr>
                                      <th>NIT: 4623515</th>
                                  </tr>
        ...
        <tbody>
            <tr>
                <td>
                    <div class="card card-default">
                        <div class="card-header text-center">
                          <b>Detalle de {{ $venta->comprobante->nombre }}</b>
                        </div>
                        <div class="card-body">
