      ...
      <div class="container-fluid">
          <div class="card shadow-md">
              <div class="card-header">
                    <h3 class="card-title-custom">Comprobantes</h3>
                    <div class="card-tools">
                        <a href="{{ route('comprobantes.create') }}" class="btn btn-primary btn-sm btn-flat" style="float:right; color:#fff">Nuevo registro</a>
                    </div>
              </div>
              <div class="card-body">
...
<script type="text/javascript">
    ...
    var obtener_data_editar = function(tbody,table){
         $(tbody).on("click","a.editar",function(e){
            ...
            var id = data.id;
             window.location.href = "/comprobantes/" + id + "/edit";
          });
